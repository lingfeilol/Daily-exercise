...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("网卡名称 : " + devices[i].name + "    |    " + devices[i].description );
...
//		 for (int n = 0; n < k.length; n++) {
		System.out.println("本机IP地址 : " + k[1].address); // 本机IP地址
		System.out.println("子网掩码   : " + k[1].subnet); // 子网掩
//		 }
		System.out.println("网络连接类型 : " + devices[1].datalink_description);
		System.out.println(
				"网卡类型：" + devices[1].description + "\n" + "网络设备所对应数据链路层的名称 " + devices[1].datalink_name);
	...
	static void startCapture() {
		...
		jpcap.NetworkInterface deviceName = devices[0];
	...
	static void loop(String st) {// 开始捕捉数据包
		...
		jpcap.loopPacket(10, new DataPacket());
